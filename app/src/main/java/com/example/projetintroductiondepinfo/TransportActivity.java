...
public class TransportActivity extends AppCompatActivity {
    ...
    final String CATEGORY = "transport";
    final String AMOUNT = "Dist (km)";
    AppDatabase db;
    long ID_ASSO;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // acquisition
        LinearLayout grille = findViewById(R.id.layout_transport);
        ...
        Bouton bou = new Bouton(this, getString(R.string.nouveau_moyen_de_transport), this::ajouter_transport);
        grille.addView(bou);
    ...
    public void onResume() {
        super.onResume();
        LinearLayout grille = findViewById(R.id.grille_transport);
        ...
        new Thread(() -> {
            ...
            for (Estimation est : estimations) {
                ...
                if (CATEGORY.equals(emi.category)) {
                    runOnUiThread(() -> {
                        BoutonBien boutonBien = ajouter_transport(null);
    ...
    public BoutonBien ajouter_transport(View view) {
        LinearLayout grille = findViewById(R.id.grille_transport);
