...
public class BiensActivity extends AppCompatActivity {

    final String CATEGORY = "bien";
    final String AMOUNT = "Qt";
    AppDatabase db;
    long ID_ASSO;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // acquisition
        LinearLayout grille = findViewById(R.id.layout_biens);
        ...
        Bouton bou = new Bouton(this, getString(R.string.nouveau_bien), this::ajouter_bien);
        grille.addView(bou);
    ...
    public void onResume() {
        super.onResume();
        LinearLayout grille = findViewById(R.id.grille_biens);
        ...
        new Thread(() -> {
            ...
            for (Estimation est : estimations) {
                ...
                if (CATEGORY.equals(emi.category)) {
                    runOnUiThread(() -> {
                        BoutonBien boutonBien = ajouter_bien(null);
    ...
    public BoutonBien ajouter_bien(View view) {
        LinearLayout grille = findViewById(R.id.grille_biens);
